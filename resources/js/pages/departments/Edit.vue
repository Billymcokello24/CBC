  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex h-full flex-1 flex-col gap-6 p-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="text-2xl font-bold tracking-tight text-gray-900">Edit Department</h1>
          <p class="text-sm text-muted-foreground">Update information for the {{ dept.name }} department</p>
        </div>
      </div>
