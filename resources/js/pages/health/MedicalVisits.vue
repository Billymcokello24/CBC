                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted-foreground">
                            Detailed record of student health assessments and
                            treatments
                        </p>
                    </div>
                </div>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y text-sm">
                        ...
                        >
                            ...
                            <td class="px-6 py-4">
                                <Badge
                                    :class="getVisitTypeColor(visit.visit_type)"
                            ...
                            <td class="px-6 py-4">
                                <div
                                    class="max-w-xs truncate font-medium text-slate-600"
                                >
                            ...
                            <td class="px-6 py-4">
                                <div
                                    class="flex items-center gap-1 font-bold text-blue-600"
                                >
