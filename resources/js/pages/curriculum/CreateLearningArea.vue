...
import { ArrowLeft, Loader2, Plus, GraduationCap, ShieldCheck } from 'lucide-vue-next';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-8 p-8 font-pulsar mt-2 max-w-[1200px] mx-auto animate-in fade-in duration-500">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Initialize Learning Domain</h1>
                    <p class="text-muted-foreground font-medium uppercase text-[10px] tracking-widest">Establish a new top-level domain within the curriculum framework</p>
                </div>
            </div>
            ...
            <div class="grid gap-8 lg:grid-cols-12">
                ...
                <div class="lg:col-span-8">
                    <form @submit.prevent="submit" class="space-y-8 rounded-[2.5rem] border bg-card p-10 shadow-sm border-t-8 border-t-emerald-500">
                        <div class="grid gap-8">
                            <div class="grid gap-4 sm:grid-cols-2 text-left">
                                <div class="space-y-2">
                                    <Label for="name" class="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Domain Nomenclature</Label>
                                    <Input id="name" v-model="form.name" class="h-12 border-slate-200 rounded-xl focus:ring-emerald-500" placeholder="e.g. Social Sciences" />
                                    <InputError :message="form.errors.name" />
                                </div>
                                <div class="space-y-2">
                                    <Label for="code" class="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Registry Code</Label>
                                    <Input id="code" v-model="form.code" class="h-12 border-slate-200 rounded-xl uppercase font-bold focus:ring-emerald-500" placeholder="e.g. SOC-SCI" />
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 text-left">
                                <div class="space-y-2">
                                    <Label for="category" class="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Framework Category</Label>
                                    <Input id="category" v-model="form.category" class="h-12 border-slate-200 rounded-xl focus:ring-emerald-500" placeholder="e.g. Core Cluster" />
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input id="display_order" v-model="form.display_order" type="number" min="0" class="h-12 border-slate-200 rounded-xl focus:ring-emerald-500" />
                            ...
                            <div class="space-y-2 text-left">
                                ...
                                <Textarea id="description" v-model="form.description" class="min-h-[120px] border-slate-200 rounded-2xl focus:ring-emerald-500 p-4" placeholder="Briefly specify the scope of this instructional domain..." />
                     ...
                     <div class="rounded-[2.5rem] bg-slate-950 p-10 shadow-2xl text-white relative overflow-hidden group border-[12px] border-slate-900">
                          ...
                          <div class="relative z-10 space-y-6">
                               <h3 class="text-xl font-black uppercase tracking-tighter flex items-center gap-3">
                                   <ShieldCheck class="h-6 w-6 text-violet-400" /> Framework Audit
                               </h3>
                               <p class="text-sm font-medium text-slate-400 leading-relaxed italic opacity-80">
                                   Initialize high-level domains to consolidate subject clusters and academic instructional pathways.
                               </p>
                               <div class="pt-6 border-t border-white/10 space-y-4">
                                    ...
                                    <div class="flex items-center justify-between text-[10px] font-black uppercase tracking-widest">
                                         ...
                                         <span class="text-violet-400 uppercase italic">Level 1 Registry</span>
                                    </div>
                               </div>
                          </div>
                     </div>
