            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-muted-foreground">
                        Create a subject and link it to a learning area
                    </p>
                </div>
            </div>
            <form
            ...
            >
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <div class="space-y-2">
                        ...
                        <select
                            ...
                            class="h-10 w-full rounded-md border bg-background px-3 text-sm transition-all focus:ring-2 focus:ring-indigo-500"
                        >
                ...
                <div class="flex justify-end gap-3">
                    <Button type="button" variant="outline" as-child
                        ><Link href="/curriculum/subjects">Cancel</Link></Button
                    ><Button
                        type="submit"
