...
import { ArrowLeft, Loader2, Plus, BrainCircuit, ShieldCheck } from 'lucide-vue-next';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-8 p-8 font-pulsar mt-2 max-w-[1200px] mx-auto animate-in fade-in duration-500">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Initialize Core Pillar</h1>
                    <p class="text-muted-foreground font-medium uppercase text-[10px] tracking-widest">Establish a new CBC core competency pillar within the academic engine</p>
                </div>
            </div>
            ...
            <div class="grid gap-8 lg:grid-cols-12">
                ...
                <div class="lg:col-span-8">
                    <form @submit.prevent="submit" class="space-y-8 rounded-[2.5rem] border bg-card p-10 shadow-sm border-t-8 border-t-indigo-500">
                        <div class="grid gap-8">
                            <div class="grid gap-4 sm:grid-cols-2 text-left">
                                <div class="space-y-2">
                                    ...
                                    <Input id="name" v-model="form.name" class="h-12 border-slate-200 rounded-xl focus:ring-indigo-500" placeholder="e.g. Critical Thinking" />
                                    <InputError :message="form.errors.name" />
                                </div>
                                <div class="space-y-2">
                                    <Label for="code" class="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Registry Code</Label>
                                    <Input id="code" v-model="form.code" class="h-12 border-slate-200 rounded-xl uppercase font-bold focus:ring-indigo-500" placeholder="e.g. CT-PILLAR" />
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 text-left">
                                <div class="space-y-2">
                                    ...
                                    <Input id="category" v-model="form.category" class="h-12 border-slate-200 rounded-xl focus:ring-indigo-500" placeholder="e.g. Cognitive" />
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input id="display_order" v-model="form.display_order" type="number" min="0" class="h-12 border-slate-200 rounded-xl focus:ring-indigo-500" />
                            ...
                            <div class="space-y-2 text-left">
                                ...
                                <Textarea id="description" v-model="form.description" class="min-h-[120px] border-slate-200 rounded-2xl focus:ring-indigo-500 p-4" placeholder="Briefly specify the behavioral indicators and scope of this core competency..." />
                     ...
                     <div class="rounded-[2.5rem] bg-slate-950 p-10 shadow-2xl text-white relative overflow-hidden group border-[12px] border-slate-900">
                          ...
                          <div class="relative z-10 space-y-6">
                               ...
                               <p class="text-sm font-medium text-slate-400 leading-relaxed italic opacity-80">
                                   Core competencies represent the behavioral anchors of the CBC framework. Indicators must be mapped once the pillar is established.
                               </p>
                               <div class="pt-6 border-t border-white/10 space-y-4">
                                    <div class="flex items-center justify-between text-[10px] font-black uppercase tracking-widest">
                                         <span class="text-slate-500">Pillar Status</span>
                                         <span class="text-emerald-400 italic">Initialized</span>
                                    </div>
                                    <div class="flex items-center justify-between text-[10px] font-black uppercase tracking-widest">
