...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Modify Domain',
        href: `/curriculum/learning-areas/${props.learningArea.id}/edit`,
    },
];
...
const submit = () => {
    ...
    })).put(`/curriculum/learning-areas/${props.learningArea.id}`);
};
</script>
                    ...
                    >
                        <div class="grid gap-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    placeholder="Specify the scope and objectives of this learning domain..."
                                />
                                <InputError
                        ...
                        >
                            ...
                            <Button
                                ...
                                class="h-12 min-w-[180px] rounded-2xl bg-indigo-600 px-8 text-xs font-bold tracking-tight uppercase shadow-xl shadow-indigo-100 hover:bg-indigo-700"
                            >
                                <Loader2
                ...
                <div class="space-y-6 lg:col-span-4">
                    ...
                    >
                        ...
                        <div class="relative z-10 space-y-6">
                            ...
                            >
                                Ensure all domain parameters align with the
                                national curriculum frameworks before
                                synchronizing updates with the global academic
                                matrix.
                            </p>
                            <div
                            ...
                            >
                                ...
                                >
                                    <span class="text-slate-500"
                                        >Access Tier</span
                                    >
                                    <span class="text-violet-400 uppercase"
                                        >Privileged</span
                                    >
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                NODE: RECL_ORC_{{ learningArea.code }}
                            </div>
                        </div>
                    </div>
                </div>
