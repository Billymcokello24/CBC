            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    >
                        ...
                        {{
                            form.processing ? 'Saving...' : 'Publish Assignment'
                        }}
                    </Button>
                </div>
            </div>
            ...
            >
                ...
                <div class="flex flex-col gap-6 lg:col-span-2">
                    ...
                    >
                        <div class="flex items-center justify-between">
                            ...
                            >
                            <Badge
                                class="rounded border-0 bg-slate-100 px-2 py-0.5 text-xs font-bold text-slate-500"
                            >
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    PDF, DOC, DOCX, PPT, Images (max 10MB each)
                                </p>
                            </div>
                        </div>
                        <input
                            ...
                            type="file"
                            multiple
                            accept=".pdf,.doc,.docx,.ppt,.pptx,.png,.jpg,.jpeg,.gif,.xls,.xlsx"
                            class="hidden"
                        ...
                        <div v-if="form.attachments.length" class="space-y-2">
                            <div
                                ...
                                :key="index"
                                class="group flex items-center justify-between rounded-xl border border-slate-50 bg-[#f9fafb] p-3 transition-all hover:border-slate-100 hover:bg-white"
                            >
                                <div class="flex items-center gap-3">
                                    <span class="text-lg">{{
                ...
                <div class="flex flex-col gap-6">
                    ...
                    >
                        ...
                        <!-- Empty strand hint -->
                        <div
                            v-if="form.subject_id && !filteredStrands.length"
                            class="rounded-xl border border-dashed border-slate-100 bg-slate-50 p-3 text-center"
                        >
                            <p
                                class="text-xs font-bold tracking-tight text-slate-400 uppercase"
                            >
                                No strands for this subject
                            </p>
                        </div>
                    </div>
