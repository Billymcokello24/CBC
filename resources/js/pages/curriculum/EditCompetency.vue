...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Modify Pillar',
        href: `/curriculum/competencies/${props.competency.id}/edit`,
    },
];
        ...
        >
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    >
                        {{ competency.name }} • PILLAR_NODE_{{ competency.id }}
                    </p>
                </div>
            </div>
            ...
            <div class="grid gap-8 lg:grid-cols-12">
                        ...
                        <div class="grid gap-8">
                            ...
                            <div class="space-y-2 text-left">
                                ...
                                <Textarea
                                    ...
                                    placeholder="Specify the behavioral indicators and scope of this core competency..."
                                />
                                <InputError
                ...
                <div class="space-y-6 lg:col-span-4">
                    ...
                    >
                        ...
                        <div class="relative z-10 space-y-6">
                            ...
                            >
                                ...
                                anchors of the CBC framework. Modifying these
                                impacts all related performance indicators.
                            </p>
                            <div
                    ...
                    <div
                        class="space-y-4 rounded-xl border bg-slate-50 p-8 text-left shadow-inner"
                    >
                        <h4
                        ...
                        <div class="space-y-2">
                            <div class="text-xs font-bold text-slate-900">
                                P_NODE_ID: {{ competency.id }}
                            </div>
                            <div
                                class="text-xs font-bold text-slate-900 uppercase"
                            >
                                UID: PILLAR_{{ competency.code }}_2026
                            </div>
                        </div>
                    </div>
                </div>
