        ...
        <form @submit.prevent="submit" class="space-y-5">
            <div class="space-y-2">
                ...
                <div class="group relative">
                    <User
                        class="absolute top-1/2 left-3 h-4 w-4 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-teal-500"
                    />
                    <Input
                        id="name"
                        v-model="form.name"
            ...
            <div class="flex items-center space-x-2">
                ...
                <Label
                    for="show_password"
                    class="cursor-pointer text-xs font-medium text-slate-500"
                    >Show characters</Label
                >
            </div>
            ...
            <p class="text-center text-xs leading-normal text-slate-400">
