                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted-foreground">
                            Modify professional profile for
            ...
            >
                ...
                <div class="space-y-6 lg:col-span-4">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <template #default="{ isUploading }">
                                        ...
                                        >
                                            ...
                                            <div
                                                v-else
                                                class="flex h-full w-full items-center justify-center text-4xl font-bold text-white/40"
                                            >
                                ...
                                <div class="text-center">
                                    ...
                                    >
                                        Update institutional profile photo.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <Badge
                            variant="outline"
                            class="rounded-lg border-purple-100 bg-purple-50 text-xs font-bold text-purple-600 uppercase"
                            >Verified</Badge
                        >
                    </div>
                </div>
                ...
                <div class="space-y-8 lg:col-span-8">
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4">
                        ...
                        <Button
                            ...
                            class="h-14 rounded-2xl border-0 bg-foreground px-12 font-bold text-background shadow-xl shadow-foreground/10 transition-all hover:bg-foreground/90"
                        >
                            <Loader2
        ...
        <Dialog :open="confirmOpen" @update:open="confirmOpen = $event">
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Are you sure you want to update the profile for
                        <strong>{{
                            `${teacher.first_name} ${teacher.last_name}`
                        }}</strong
                        >?
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle class="text-destructive"
                        >Delete staff account?</DialogTitle
                    >
                    <DialogDescription>
                        This will permanently delete the staff record and their
