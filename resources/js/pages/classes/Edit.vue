        ...
        >
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            ...
                            <Badge
                                variant="secondary"
                                class="h-5 rounded-full border-none bg-blue-50 px-3 py-0.5 text-[10px] font-bold text-blue-600 uppercase"
                                >Academic Setup</Badge
                            >
                        </div>
                        <p class="mt-1 text-sm text-muted-foreground font-medium">
                            Update grade, stream, and capacity for
            ...
            <div class="max-w-4xl">
                <form @submit.prevent="submit" class="space-y-8">
                    ...
                    >
                        ...
                        >
                            ...
                            <p class="text-xs font-medium text-muted-foreground"
                                >Essential details for class identification and capacity.</p
                            >
                        </div>
                        <div class="p-8">
                            <div class="grid gap-8 md:grid-cols-2">
                                <div class="space-y-3">
                                    ...
                                    <Input
                                        ...
                                        class="h-11 rounded-lg border-border focus:ring-primary"
                                    />
                                ...
                                <div class="space-y-3">
                                    ...
                                    <Input
                                        ...
                                        v-model="form.code"
                                        placeholder="e.g. G1R"
                                        class="h-11 rounded-lg border-border uppercase focus:ring-primary"
                                    />
                            ...
                            >
                                <div class="space-y-3">
                                    ...
                                    <select
                                        ...
                                        class="h-11 w-full rounded-lg border border-border bg-background px-4 text-xs font-bold outline-none focus:ring-primary"
                                    >
                                        <option
                    ...
                    >
                        <div
                            class="flex items-center justify-between bg-muted/50 p-8"
                        >
                            <div class="flex items-center gap-4">
                                <div
                                    class="flex h-10 w-10 items-center justify-center rounded-lg border bg-background shadow-sm"
                                >
                                    <component
                                        :is="
                                            form.is_active
                                ...
                                <div>
                                    ...
                                    <p class="text-xs font-medium text-muted-foreground">
                                        {{
                                            form.is_active
                                                ? 'Class is currently active and accepts students'
                            ...
                            <select
                                ...
                                class="h-10 min-w-[140px] rounded-lg border border-border bg-background px-4 text-xs font-bold tracking-wider uppercase outline-none focus:ring-primary"
                            >
