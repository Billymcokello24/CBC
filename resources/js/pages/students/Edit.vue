            ...
            <div class="flex items-center gap-4 border-b border-slate-100 pb-6">
                ...
                <div>
                    <div class="flex items-center gap-2">
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none">Edit Learner</h1>
                        <Badge variant="outline" class="rounded-full px-3 py-0.5 h-5 text-[7px] font-black uppercase tracking-[0.2em] border-blue-200 text-blue-500 italic bg-blue-50/50">Update details</Badge>
                    </div>
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1.5 opacity-70">Update the learner's personal and school details</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <div class="p-8">
                        <div class="grid gap-6 md:grid-cols-2">
                            <div class="space-y-1.5">
                                ...
                                <Input id="guardian_name" v-model="form.guardian_name" placeholder="Full Name" class="h-10 rounded-xl border-slate-200 bg-slate-50 font-bold px-4 focus:ring-blue-500 text-xs" />
                            ...
                            <div class="space-y-1.5">
                                ...
                                <Input id="guardian_email" v-model="form.guardian_email" type="email" placeholder="guardian@example.com" class="h-10 rounded-xl border-slate-200 bg-slate-50 font-bold px-4 focus:ring-blue-500 text-xs" />
                            ...
                            <div class="space-y-1.5">
                                ...
                                <Input id="guardian_phone" v-model="form.guardian_phone" placeholder="+254 XXX XXX XXX" class="h-10 rounded-xl border-slate-200 bg-slate-50 font-bold px-4 focus:ring-blue-500 text-xs" />
                            ...
                            <div class="space-y-1.5">
                                ...
                                <Input id="guardian_password" v-model="form.guardian_password" type="password" placeholder="Leave blank to keep current" class="h-10 rounded-xl border-slate-200 bg-slate-50 font-bold px-4 focus:ring-blue-500 text-xs font-mono" />
                                <InputError :message="form.errors.guardian_password" />
                            </div>
                            <div class="space-y-1.5 md:col-span-2">
                                <Label for="guardian_password_confirmation" class="text-[9px] font-black uppercase text-slate-400 tracking-widest pl-1">Confirm Password</Label>
                                <Input id="guardian_password_confirmation" v-model="form.guardian_password_confirmation" type="password" placeholder="Re-enter password" class="h-10 rounded-xl border-slate-200 bg-slate-50 font-bold px-4 focus:ring-blue-500 text-xs font-mono" />
                ...
                <div class="flex items-center justify-between gap-6 pt-8 border-t border-slate-100">
                     <div class="hidden sm:flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-50 text-blue-600 border border-blue-100 italic font-black uppercase text-[7px] tracking-[0.2em]">
                        Data validation active <Loader2 class="h-3 w-3 animate-pulse" />
                     </div>
