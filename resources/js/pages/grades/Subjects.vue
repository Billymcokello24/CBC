    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="rounded-xl border bg-card p-4">
                    <div class="text-sm text-muted-foreground">Compulsory</div>
                    <div class="mt-2 text-2xl font-bold text-blue-600">
                        {{ stats.compulsory }}
                    </div>
                </div>
                <div class="rounded-xl border bg-card p-4">
                    <div class="text-sm text-muted-foreground">Examinable</div>
            ...
            <div class="rounded-xl border bg-card p-6">
                ...
                >
                    <div>
                        <h2 class="text-lg font-semibold">
                            Grade Curriculum Subjects
                        </h2>
                        <p class="text-sm text-muted-foreground">
                            Open a subject, edit it, allocate it to grades, or
                    ...
                    <div class="flex items-center gap-2">
                        <Button
                            ...
                            size="sm"
                            @click="viewMode = 'grid'"
                            ><GraduationCap class="mr-2 h-4 w-4" />Grid
                            View</Button
                        >
                        <Button
                            :variant="
                            ...
                            size="sm"
                            @click="viewMode = 'list'"
                            ><List class="mr-2 h-4 w-4" />List View</Button
                        >
                    </div>
                </div>
                ...
                >
                    No subjects allocated to this grade yet.
                </div>
                                ...
                                <DropdownMenuContent align="end">
                                    ...
                                    <DropdownMenuItem as-child
                                        ><Link
                                            ...
                                            ><ClipboardList
                                                class="mr-2 h-4 w-4"
                                            />Allocate to Grades</Link
                                        ></DropdownMenuItem
                                    >
                                    <DropdownMenuItem as-child
                                        ><Link
                                            :href="`/classes/allocations?grade_id=${grade.id}&subject_id=${subject.id}`"
                                            ><Users
                                                class="mr-2 h-4 w-4"
                        ...
                        {{
                            confirmMode === 'delete'
                                ...
                                : confirmMode === 'activate'
                                  ? `Activate ${selectedSubject.name}?`
                                  : `Deactivate ${selectedSubject.name}?`
                        }}
                    </p>
