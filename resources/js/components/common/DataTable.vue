            ...
            >
                <template v-for="filter in filters" :key="filter.key">
                    <Select
                        ...
                        @update:model-value="
                            (v) => handleFilter(filter.key, v as string)
                        "
                    >
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b bg-muted/50">
                            ...
                            <th
                                class="w-20 px-4 py-3 text-right text-sm font-medium text-muted-foreground"
                            >
                                Actions
                            </th>
                        </tr>
                        ...
                        <template v-if="loading">
                            <tr v-for="i in 5" :key="i">
                                <td v-if="selectable" class="px-4 py-3">
                                    <div
                                        class="h-4 w-4 animate-pulse rounded bg-muted"
                                    ></div>
                                </td>
                                <td
                                    v-for="column in columns"
                                ...
                                <td class="px-4 py-3">
                                    <div
                                        class="h-4 w-8 animate-pulse rounded bg-muted"
                                    ></div>
                                </td>
                            </tr>
                        </template>
                        ...
                        <template v-else-if="data.length > 0">
                            ...
                            >
                                ...
                                <td
                                    ...
                                    :key="column.key"
                                    :class="
                                        cn('px-4 py-3 text-sm', column.class)
                                    "
                                >
                                    <slot
