        ...
        <DialogContent class="font-pulsar sm:max-w-[550px]">
            <DialogHeader>
                ...
                <DialogDescription class="font-medium text-slate-500">
                    {{
                        strand
                            ? 'Refine strand definitions and topical scope.'
                            : 'Initialize a new topic strand within the subject hierarchy.'
                    }}
                </DialogDescription>
            </DialogHeader>
            ...
            <form @submit.prevent="submit" class="grid gap-5 py-4">
                ...
                <DialogFooter class="pt-4">
                    ...
                    <Button
                        ...
                        class="h-10 bg-amber-600 px-6 text-xs font-bold tracking-tight uppercase shadow-lg shadow-amber-100 hover:bg-amber-700"
                    >
