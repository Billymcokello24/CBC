        ...
        items: [
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        href: '/super-admin/schools/status',
                    },
                    {
                        title: 'Modular Config',
                        href: '/super-admin/schools/modules',
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        title: 'Audit Logs',
                        href: '/super-admin/impersonation/logs',
                    },
        ...
        items: [
            {
                ...
                children: [
                    ...
                    {
                        title: 'Feature Flags',
                        href: '/super-admin/config/flags',
                        icon: ToggleLeft,
                    },
                    {
                        title: 'Global Templates',
                        href: '/super-admin/config/templates',
                    },
                    {
                        title: 'Integrations',
                        href: '/super-admin/config/integrations',
                    },
                ],
            },
            {
                ...
                children: [
                    {
                        title: 'Core Modules',
                        href: '/super-admin/modules/core',
                    },
                    {
                        title: 'Premium Addons',
                        href: '/super-admin/modules/premium',
                    },
                    {
                        title: 'Beta Testing',
                        href: '/super-admin/modules/beta',
                    },
                ],
            },
            {
        ...
        items: [
            {
                ...
                children: [
                    {
                        title: 'Usage Trends',
                        href: '/super-admin/analytics/usage',
                    },
                    {
                        title: 'Growth Metrics',
                        href: '/super-admin/analytics/growth',
                    },
        ...
        items: [
            {
                ...
                children: [
                    {
                        title: 'Server Status',
                        href: '/super-admin/devops/servers',
                        icon: Server,
                    },
                    {
                        title: 'Deployments',
                        href: '/super-admin/devops/deploys',
                    },
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        href: '/super-admin/support/kb',
                    },
                    {
                        title: 'System Updates',
                        href: '/super-admin/support/updates',
                    },
                ],
            },
            {
                ...
                children: [
                    {
                        title: 'Terminal',
                        href: '/super-admin/developer/terminal',
                        icon: Terminal,
                    },
                    {
                        title: 'Database UI',
                        href: '/super-admin/developer/db-ui',
                    },
                    {
                        title: 'GraphQL Playground',
                        href: '/super-admin/developer/graphql',
                    },
                    {
                        title: 'Tools',
        ...
        items: [
            {
                ...
                children: [
                    ...
                    {
                        title: 'Lesson Plan',
                        href: '/curriculum/planner/lesson-plans',
                    },
                    {
                ...
                children: [
                    {
                        title: 'My Timetable',
                        href: '/timetable/my',
                        permissions: ['timetable.view_own'],
                    },
                    {
        ...
        items: [
            {
                ...
                children: [
                    ...
                    { title: 'Subject Report', href: '/reports/subject-performance' },
                    { title: 'Class Report', href: '/reports/class-summary' },
                    { title: 'Attendance Report', href: '/reports/attendance' },
                    { title: 'Assessment Report', href: '/reports/assessments' },
                    { title: 'Competency Report', href: '/reports/competency-mastery' },
                    { title: 'Learner Report', href: '/reports/learner-profile' },
                    { title: 'Teacher Report', href: '/reports/teacher-metrics' },
                    { title: 'Finance Report', href: '/reports/finance' },
                    { title: 'Enrollment Report', href: '/reports/enrollment' },
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        permissions: ['library.issue_books'],
                    },
                    {
                        title: 'Categories',
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        permissions: ['communication.announcements'],
                    },
                ],
            },
            {
    ...
    const nav: any[] = [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    icon: Users,
                    hidden:
                        !teacherRoles.value.assigned_classes_count &&
                        !teacherRoles.value.is_class_teacher,
                },
            ],
        },
        {
                ...
                },
                {
                    ...
                    children: [
                        { title: 'My Students', href: '/students' },
                        {
                            ...
                            href: '/students',
                            hidden: !teacherRoles.value.is_class_teacher,
                        },
                    ],
                },
                {
...
const filteredNavigation = computed(() => {
    ...
    if (isTeacherRole.value) {
        return teacherNavigation.value
            .map((group) => ({
                ...group,
...
<template>
    <Sidebar collapsible="offcanvas">
        <SidebarHeader
            class="flex h-auto flex-col items-center justify-center border-b border-sidebar-border px-6 py-6"
        >
            <!-- Super Admin Context (Global) -->
            <Link
                href="/super-admin/dashboard"
                v-if="isSuperAdmin && !isImpersonating"
                class="flex items-center gap-3 font-bold text-sidebar-foreground"
            >
                <div
                    class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary text-primary-foreground shadow-lg shadow-primary/20"
                >
            ...
            >
                ...
                >
                    <img
                        ...
                        :alt="$page.props.auth.school.name"
        ...
        <SidebarContent class="custom-scrollbar pb-32">
            ...
            >
                <SidebarGroupLabel
                    class="px-2 text-xs font-medium tracking-tight text-muted-foreground text-sidebar-foreground/40 uppercase"
                >
                    {{ group.title }}
                </SidebarGroupLabel>
                <SidebarGroupContent>
                        ...
                        >
                            <div v-if="item.children">
                                ...
                                >
                                    ...
                                    <ChevronDown
                                        class="h-3 w-3 opacity-50 transition-transform duration-300"
                                        :class="{
                                            'rotate-180':
                                                activeItem === item.title,
                                        }"
                                ...
                                <div
                                    ...
                                    class="mt-1 ml-4 animate-in space-y-1 border-l border-sidebar-border pl-4 duration-300 slide-in-from-top-2"
                                >
                                    <Link
                    ...
                    <div v-if="item.children">
                        ...
                        >
                            ...
                            <ChevronDown
                                class="h-3 w-3 opacity-50 transition-transform duration-300"
                                :class="{
                                    'rotate-180': activeItem === item.title,
                                }"
                            />
                        </SidebarMenuButton>
                        <div
