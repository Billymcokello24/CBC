...
<template>
    ...
    >
        <div class="relative hidden h-full flex-col p-12 text-white lg:flex">
            ...
            <div class="absolute inset-0 z-0 overflow-hidden bg-slate-900">
                <img
                    ...
                    :src="image"
                    alt="Background"
                    class="animate-slow-zoom h-full w-full scale-105 object-cover opacity-60"
                />
                <div
            ...
            <div class="relative z-20 flex items-center">
                ...
                >
                    <div
                        class="flex h-10 w-10 items-center justify-center rounded-xl bg-white/10 ring-1 ring-white/20 backdrop-blur-md"
                    >
            ...
            <div class="relative z-20 mt-auto">
                <div class="max-w-lg space-y-6">
                    <blockquote class="space-y-2">
                        <p class="text-3xl leading-tight font-medium">
                            &ldquo;{{
                                quote ||
                                'Empowering the next generation of learners through innovative digital tools and seamless curriculum management.'
                            }}&rdquo;
                        </p>
                        <footer class="pt-4">
            ...
            <div
                class="relative z-20 mt-12 flex items-center gap-6 text-sm text-white/40"
            >
