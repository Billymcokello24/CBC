...
<body>
    ...
    <div class="footer">Generated on {{ date('d M Y, H:i') }} &bull; Academic Streams Registry</div>

    <div class="doc-title-block">
        <div class="doc-title">Educational Streams Directory</div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th width="20%">Stream Code</th>
                <th width="20%">Default Capacity</th>
                <th width="15%">Classes Count</th>
                <th width="15%">Total Learners</th>
            </tr>
        </thead>
        <tbody>
