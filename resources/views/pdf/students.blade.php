...
<body>
    ...
    <div class="footer">
        Generated on {{ date('d M Y, H:i') }} &bull; Student Enrollment Registry
    </div>

    <div class="doc-title-block">
        <div class="doc-title">Student Enrollment Directory</div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                <td style="font-weight: bold;">{{ $item->upi_number ?? $item->admission_number }}</td>
