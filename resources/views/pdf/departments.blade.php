...
<body>
    ...
    <div class="footer">Generated on {{ date('d M Y, H:i') }} &bull; Departmental Structure</div>

    <div class="doc-title-block">
        <div class="doc-title">Academic Departments Registry</div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->name }}</td>
                <td>{{ $item->headOfDepartment?->full_name ?? '—' }}</td>
                <td>{{ $item->teachers_count }} Teachers</td>
                <td>{{ $item->subjects_count }} Subjects</td>
            </tr>
            @endforeach
        </tbody>
    </table>
