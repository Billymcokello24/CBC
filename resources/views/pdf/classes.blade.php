...
<body>
    ...
    <div class="footer">Generated on {{ date('d M Y, H:i') }} &bull; Class Structure Registry</div>

    <div class="doc-title-block">
        <div class="doc-title">Classroom Registry Directory</div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->name }}</td>
                <td>{{ $item->gradeLevel?->name ?? '—' }}</td>
                <td>{{ $item->stream?->name ?? '—' }}</td>
                <td>{{ $item->classTeacher?->name ?? '—' }}</td>
                <td>{{ $item->learners_count }} / {{ $item->capacity }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
